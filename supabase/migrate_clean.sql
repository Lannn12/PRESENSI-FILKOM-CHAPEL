-- ================================================================
-- CLEAN MIGRATION - Drop semua tabel lama & buat ulang
-- ⚠️  PERHATIAN: Ini akan MENGHAPUS semua data yang ada!
...
drop table if exists public.absenter_group_members cascade;
drop table if exists public.meetings cascade;
drop table if exists public.sections cascade;
drop table if exists public.absenter_groups cascade;
